            ...
            <div class="form-group">
              <div class="form-row container">
                  <div class="col-md-4">
                    ...
                    <input class="form-control" name="nama_delegasi" type="text" placeholder="Enter nama delegasi">
                </div>
                <div class="col-md-4">
                ...
                <div class="col-md-4">
                    ...
                    <input class="form-control" name="angkatan" type="text" placeholder="Enter Angkatan">
                </div>
              </div>
              </div>
                <input class="container btn btn-primary btn-block col-md-4" type="submit" value="Submit" name="tambah" />
            </div>
          </form>
        </div>
        </div>
