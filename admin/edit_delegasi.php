  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Form delegasi</li>
      </ol>
    </div>
...
<!--content isi-->    
    <div class="container">
      <div class="card"> 
        <div class="card-header">Form Data Delegasi</div>
<?php  
  include('../config/koneksi.php');
  
  $id = $_GET['id'];
  $show = mysql_query("SELECT * FROM tb_delegasi WHERE id_delegasi ='$id'");
...
?>
      <form action="php/ps-edit-delegasi.php" method="POST">
        <div class="card-body">
            <div class="form-group">
              <div class="form-row container">
                <input type="hidden" name="id" value="<?php echo $id; ?>">
                <div class="col-md-4">
                    <label for="delegasi">Nama Delegasi</label>
                    <input class="form-control" name="nama_delegasi" type="text" value="<?php echo $data['nama_delegasi']; ?>" required>
                </div>
                <div class="col-md-4">
                ...
                <div class="col-md-4">
                    ...
                    <input class="form-control" name="angkatan" type="text" value="<?php echo $data['angkatan']; ?>" required>
                </div>
              </div>
              </div>
                <input class="container btn btn-primary btn-block col-md-4" type="submit" value="Simpan" name="simpan" />
            </div>
          </form>
        </div>
        </div>
